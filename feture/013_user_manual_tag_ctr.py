...
train = train[['instance_id', 'userid', 'feedid', 'device', 'manual_tag_list', 'date_'] + y_cols].copy()
...
features_df.to_pickle('./features/tr_user_manual_tag_list_hist_ctr.pkl')
