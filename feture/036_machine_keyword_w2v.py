...
total_label = total_label[['instance_id', 'userid', 'machine_keyword_list']]
...
total_label = total_label.explode('machine_keyword_list').reset_index(drop=True)
...
features_df = df_w2v.set_index('machine_keyword_list')
features_df = reduce_mem_usage(features_df, list(features_df))

features_df.to_pickle('./proc/all_machine_keyword_list_w2v.pkl')
...
total_label.to_pickle('./features/tr_machine_keyword_w2v.pkl')
